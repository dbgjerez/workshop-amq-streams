...
```
oc apply -f operator/operator-group-monitoring.yaml
```
...
[source, yaml]
include::https://raw.githubusercontent.com/dbgjerez/workshop-amq-streams/master/content/prometheus/prometheus-pod-monitor.yaml[]
...
[source, yaml]
include::https://raw.githubusercontent.com/dbgjerez/workshop-amq-streams/master/content/grafana/grafana-datasource.yaml[]

Also a Grafana instance is necessary, check it out the following descriptor:

[source, yaml]
include::https://raw.githubusercontent.com/dbgjerez/workshop-amq-streams/master/content/grafana/grafana.yaml[]
